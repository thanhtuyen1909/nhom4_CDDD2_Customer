...
public class SectionedExpandableLayoutHelper implements SectionStateChangeListener {
    ...
    //data list
    private LinkedHashMap<Section, ArrayList<Products>> mSectionDataMap = new LinkedHashMap<Section, ArrayList<Products>>();
    ...
    public void addSection(String section, ArrayList<Products> items) {
        Section newSection;
        mSectionMap.put(section, (newSection = new Section(section)));
        mSectionDataMap.put(newSection, items);
    }

    public void addItem(String section, Products item) {
        mSectionDataMap.get(mSectionMap.get(section)).add(item);
    }

    public void removeItem(String section, Products item) {
    ...
    public void removeAll() {
        try{
            ...
            Toast.makeText(mRecyclerView.getContext(), "Co loi", Toast.LENGTH_SHORT).show();
        }
    ...
    private void generateDataList () {
        ...
        for (Map.Entry<Section, ArrayList<Products>> entry : mSectionDataMap.entrySet()) {
            Section key;
