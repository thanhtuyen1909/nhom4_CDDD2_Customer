...
import vn.edu.tdc.zuke_customer.adapters.ProductsHomeCategoryAdapter;
import vn.edu.tdc.zuke_customer.adapters.ProductsHomeSuggestionAdapter;
...
public class UserHomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        queryGetCustomer = FirebaseDatabase.getInstance().getReference().
                child("Customer").orderByChild("accountID").equalTo(GlobalIdUser.userId);
